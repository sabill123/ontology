...
class EmbeddedPhase3LLMJudge:
    ...
    # v27.10: _get_judge_system_prompt, _build_judge_prompt, _parse_llm_response 삭제
    # — v27.9에서 LLM Judge 경로 제거, rule-based only로 전환되어 dead code
    ...
    # v27.10: _llm_domain_adjustment 삭제 — v27.9에서 LLM 경로 비활성화로 dead code
